...
function ProfileButton(props){
	...
	return(
		...
		<Button bg="none" _hover={{
			bg: props.backg, color: fore, textDecoration: "underline"
		}} fontSize="25px"
		display="flex" alignItems="center" justifyContent="space-between"
		width="250px" textUnderlineOffset="5px"
		>{props.icon}
...
function WebProfiles(){
	...
	return (
		...
		mt="20px"
		>
		<ProfileButton link="https://www.youtube.com/@AxewBoTX" backg={yt_bg} text={"Axew TV"} icon={<FaYoutube size={35}/>}/>
		<ProfileButton link="https://www.twitch.tv/axewbotx" backg={twitch_bg} text={"@axewbotx"} icon={<FaTwitch size={35}/>}/>
		<ProfileButton link="https://twitter.com/AxewBoTX" backg={twitter_bg} text={"@AxewBoTX"} icon={<FaTwitter size={35}/>}/>
		<ProfileButton link="https://github.com/AxewBoTX" backg={github_bg} text={"AxewBoTX"} icon={<FaGithub size={35}/>}/>
		</Flex>
		</Box>
	);
}
